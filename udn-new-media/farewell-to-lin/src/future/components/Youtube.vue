<template>
  ...
  <section class="youtube" @scroll.prevent>
    ...
    <iframe class="youtube__player" id="youtube" src="https://www.youtube.com/embed/k5_iIp_Rab8?enablejsapi=1&modestbranding=1&rel=0&showinfo=0&iv_load_policy=3&loop=1&origin=https://udn.com" frameborder="0"></iframe>
  </section>
</template>
