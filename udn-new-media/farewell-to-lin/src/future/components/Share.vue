<template>
  <section class="share">
    <div class="share__fb-like-wrapper">
      ...
      <!-- <div class="fb-like" data-href="http://nmdap.udn.com.tw/cloudgate/future.html" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div> -->
    </div>
    <div @click="lineShare">
  ...
  methods: {
    lineShare() {
      if (Utils.detectMob()) {
        ...
        // window.open(`//line.me/R/msg/text/?${document.querySelector('title').innerHTML}%0D%0A%0D%0A${document.querySelector('meta[property="og:description"]').content}%0D%0A%0D%0Ahttp://nmdap.udn.com.tw/cloudgate/future.html`);
      } else {
        window.open('https://lineit.line.me/share/ui?url=https://udn.com/upf/newmedia/2018_data/cloudgate/future.html');
        // window.open('https://lineit.line.me/share/ui?url=http://nmdap.udn.com.tw/cloudgate/future.html');
      }
    },
  },
};
