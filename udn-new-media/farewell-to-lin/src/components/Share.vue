<template>
  <section class="share">
    <div class="share__fb-like-wrapper">
      ...
      <div class="fb-like" data-href="https://udn.com/upf/newmedia/2017_data/ideal/index.html" data-layout="button_count" data-action="like" data-size="small" data-show-faces="true" data-share="true"></div>
    </div>
    <div @click="lineShare">
