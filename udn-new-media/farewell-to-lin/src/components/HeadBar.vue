    ...
    <transition name="list-fade">
      <div class="header-list" v-if="isListOpen && $root.isMobileSize">
        <nav class="header-list__anchor-menu">
          <ul class="header-list__anchor--inner">
            <!-- <li class="header-list__anchor-item">台灣是我們的共業</li> -->
            <!-- <ul class="header-list__inner-anchor"> -->
            <li class="header-list__anchor-main">台灣是我們的共業</li>
            <li class="header-list__anchor-item">退休前心內話</li>
            <li class="header-list__anchor-item">預告的背後故事</li>
            <li class="header-list__anchor-item">給台灣的情書</li>
            <!-- </ul> -->
          </ul>
          <ul class="header-list__anchor--outer">
            <li class="header-list__anchor-main">雲門大船的未來進行式</li>
          </ul>
        </nav>
      </div>
    </transition>
