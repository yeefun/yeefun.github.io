<template>
  <article class="content content--dark">
    <h2 class="content__title content__title--dark">45年來<br>努力實踐「懷民」</h2>
    ...
    <div class="content__quote-wrapper">
      ...
      <p class="content__quote-speaker">雲門舞集助理藝術總監&ensp;李靜君</p>
    </div>
    ...
    <div class="content__text">
      ...
      <p><br></p>
      <p>再之後的《水月》（1998）、以及代表作行草三部曲（行草、松煙、狂草），則反映林懷民感受到的「精緻台灣」。「對我來說，《家族合唱》是台灣，《水月》也是台灣」，林懷民說，1998年的台灣生活已經漸走向中產、精緻，有愛樂電台也有誠品書店，社會已經不一樣了。</p>
    </div>
    <div class="content__quote-wrapper">
